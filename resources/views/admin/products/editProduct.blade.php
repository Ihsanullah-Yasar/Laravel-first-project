        ...
        <div class="col-lg-10">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" method="POST" action="{{route('shop.update',$product->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-12">
                  <label for="title" class="form-label">Name</label>
                  <input type="text" value="{{$product->name}}" name="title" class="form-control">
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  ...
                  <input type="text" class="form-control" value="{{$product->discount_price}}" name="discount_price" id="discount_price">
                </div>
                <div class="col-12">
