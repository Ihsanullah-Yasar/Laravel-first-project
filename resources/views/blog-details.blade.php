                ...
                <div class="col-lg-12">
                    <div class="blog-details-inner">
                        ...
                        <div class="blog-large-pic">
                            <img src="<?php echo asset("$blog->image")?>"  alt="blog image">
                        </div>
                        ...
                        <div class="blog-more">
                            <div class="row">
                                <div class="col-sm-4">
                                    <img src="{{ asset('assets/img/blog/blog-detail-1.jpg') }} " alt="">
                                </div>
                                <div class="col-sm-4">
                                    <img src="{{ asset('assets/img/blog/blog-detail-2.jpg') }} " alt="">
                                </div>
                                <div class="col-sm-4">
                                    <img src="{{ asset('assets/img/blog/blog-detail-3.jpg') }} " alt="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <a href="#" class="prev-blog">
                                        <div class="pb-pic">
                                            ...
                                            <img src="{{ asset('assets/img/blog/prev-blog.png') }} " alt="">
                                        </div>
                                        <div class="pb-text">
                                ...
                                <div class="col-lg-5 offset-lg-2 col-md-6">
                                    <a href="#" class="next-blog">
                                        <div class="nb-pic">
                                            <img src="{{ asset('assets/img/blog/next-blog.png') }} " alt="">
